...
public class ReadActor {
    ...
    public ReadActor(boolean isUseBase64) throws Exception {
        isBase64 = isUseBase64;
        users = new IniEditor();
        users.load(ConfigName);
        String XlsFileName = users.get("actor", "sheetFiles");
    ...
    public void parse(Workbook workbook) throws Exception {
        ...
        String binFileName = users.get("actor", "binFiles");
        //生成的json文件名
        ...
        MainFrame.append("*******************************");
        MainFrame.append(" 角色属性表(ac.bin) " + MainFrame.getNowTime() + " 导出成功...");
        MainFrame.append("*******************************");
    }
