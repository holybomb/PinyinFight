...
// XXX
#ifdef Hunter
		if (pKeyframe0->getEasingType() ==  kCCBKeyframeEasingInstant)
		{
			return CCSequence::createWithTwoActions(CCDelayTime::create(duration), CCScaleTo::create(0, x, y));
		}
		else
		{
...
#ifdef Hunter
CCDictionary* CCBAnimationManager::getNodeSequences() const
{
	return mNodeSequences;
}
#endif // Hunter
