...
//////////////////////////////////////////////////////////////////////////
bool textConvert::safeAddToOutbuf(char* outbuf,int iOutbuf,char* pinyinValue,int iPinyinValue) 
{
...
const char *_pinyin_table_[20902] = {
	...
	int textConvert::is_utf8_string(char *utf)
	{
	...
	void textConvert::pinyin_utf8(char* inbuf,char* outbuf, bool m_blnSimaple,bool polyphone_support,bool m_blnFirstBig,bool m_blnAllBiG,bool m_LetterEnd, bool m_unknowSkip,bool m_filterPunc)
	{
		...
		for (int i=0;i<inbuf_len;i++)
		{
			if ( (unsigned char)inbuf[i] < 0x80 )  {  //若是英文或数字
				...
				if (uni>19967&&uni<40870)
				{
					...
					strncpy(py_tmp, _pinyin_table_[uni - 19968],HZ2PY_MAX_PINYIN_SIZE);
					...
					{
						strncpy(py_tmp2, py_tmp,HZ2PY_MAX_PINYIN_SIZE);
					}
	...
	int textConvert::findLetter(int nCode, char* strValue)  
	{ 
		switch(nCode)  
		{  
		case 6325:  
		...
		case 7571:  
		case 7925:  
			strncpy(strValue,"A",HZ2PY_MAX_PINYIN_SIZE);
			break;  
		case 6263:  
		case 6440:  
		case 7040:  
		...
		case 7945:  
		case 8616:
			strncpy(strValue,"AI",HZ2PY_MAX_PINYIN_SIZE);  
			break;  
		case 5847:  
		case 5991:  
		case 6278:  
		...
		case 8038:  
		case 8786:  
			strncpy(strValue,"AN",HZ2PY_MAX_PINYIN_SIZE); 
			break;  
			strncpy(strValue,"ANG",HZ2PY_MAX_PINYIN_SIZE); 
			break;  
		case 5974:  
		case 6254:  
		case 6427:  
		...
		case 8701:  
		case 8773:  
			strncpy(strValue,"AO",HZ2PY_MAX_PINYIN_SIZE);
			break;  
		case 6056:  
		case 6135:  
		case 6517:  
		...
		case 8649:  
		case 8741:  
			strncpy(strValue,"BA",HZ2PY_MAX_PINYIN_SIZE);  
			break;  
		case 6267:  
		case 6334:  
		case 7494:  
			strncpy(strValue,"BAI",HZ2PY_MAX_PINYIN_SIZE);
			break;  
		case 5870:  
		case 5964:  
		case 7851:  
		...
		case 8113:  
		case 8418:  
			strncpy(strValue,"BAN",HZ2PY_MAX_PINYIN_SIZE);
			break;  
		case 6182:  
		case 6826:  
			strncpy(strValue,"BANG",HZ2PY_MAX_PINYIN_SIZE); 
			break;  
		case 6165:  
		case 7063:  
		case 7650:  
		...
		case 8532:  
		case 8621: 
			strncpy(strValue,"BAO",HZ2PY_MAX_PINYIN_SIZE); 
			break;  
		case 5635:  
		case 5873:  
		case 5893:  
		...
		case 8645:  
		case 8725:  
			strncpy(strValue,"BEI",HZ2PY_MAX_PINYIN_SIZE); 
			break;  
		case 5946:  
		case 5948:  
		case 7458:  
		case 7928:  
			strncpy(strValue,"BEN",HZ2PY_MAX_PINYIN_SIZE); 
			break;  
		case 6452:  
		case 7420:  
			strncpy(strValue,"BENG",HZ2PY_MAX_PINYIN_SIZE); 
			break;  
		case 5616:  
		case 5734:  
		case 6074:  
		...
		case 8547:  
		case 8734:  
			strncpy(strValue,"BI",HZ2PY_MAX_PINYIN_SIZE);  
			break;  
		case 5650:  
		case 5945:  
		case 6048:  
		...
		case 8354:  
		case 8693:  
			strncpy(strValue,"BIAN",HZ2PY_MAX_PINYIN_SIZE);
			break;  
		case 7027:  
		case 7084:  
		case 7609:  
		...
		case 8707:  
		case 8752:  
			strncpy(strValue,"BIAO",HZ2PY_MAX_PINYIN_SIZE);  
			break;  
		case 8531:  
			strncpy(strValue,"BIE",HZ2PY_MAX_PINYIN_SIZE);
			break;  
		case 5747:  
		case 6557:  
		case 7145:  
		...
		case 8738:  
		case 8762: 
			strncpy(strValue,"BIN",HZ2PY_MAX_PINYIN_SIZE); 
			break;  
		case 5787:  
		case 5891:  
		case 6280:  
			strncpy(strValue,"BING",HZ2PY_MAX_PINYIN_SIZE);  
			break;  
		case 5781:  
		case 6403:  
		case 6636:  
		...
		case 8543:  
		case 8559:  
			strncpy(strValue,"BO",HZ2PY_MAX_PINYIN_SIZE); 
			break;  
		case 6318:  
		case 6945:  
		case 7419:  
		...
		case 7863:  
		case 8519:  
			strncpy(strValue,"BU",HZ2PY_MAX_PINYIN_SIZE); 
			break;  
		case 6474:  
		case 7769:  
			strncpy(strValue,"CA",HZ2PY_MAX_PINYIN_SIZE);
			break;  
			strncpy(strValue,"CAI",HZ2PY_MAX_PINYIN_SIZE); 
			break;  
		case 6978:  
		case 7078:  
		case 7218:  
		case 8451:  
		case 8785: 
			strncpy(strValue,"CAN",HZ2PY_MAX_PINYIN_SIZE);  
			break;  
		case 5687:  
			strncpy(strValue,"CANG",HZ2PY_MAX_PINYIN_SIZE);
			break;  
		case 6448:  
		case 6878:  
		case 8309:  
		case 8429:  
			strncpy(strValue,"CAO",HZ2PY_MAX_PINYIN_SIZE);
			break;  
		case 6692:
			strncpy(strValue,"CE",HZ2PY_MAX_PINYIN_SIZE);  
			break;  
		case 6515:  
		case 6825:  
			strncpy(strValue,"CEN",HZ2PY_MAX_PINYIN_SIZE); 
			break;  
		case 6465:  
			strncpy(strValue,"CENG",HZ2PY_MAX_PINYIN_SIZE);  
			break;  
		case 6639:  
		case 6766:  
		case 7017:  
		...
		case 7979:  
		case 8135:  
			strncpy(strValue,"CHA",HZ2PY_MAX_PINYIN_SIZE); 
			break;  
		case 5713:  
		case 7846:  
		case 8091:  
		case 8218:  
			strncpy(strValue,"CHAI",HZ2PY_MAX_PINYIN_SIZE);
			break;  
		case 5770:  
		case 5838:  
		case 6159:  
		...
		case 8324:  
		case 8580:  
			strncpy(strValue,"CHAN",HZ2PY_MAX_PINYIN_SIZE);
			break;  
		case 5686:  
		case 5943:  
		case 6041:  
		...
		case 7509:  
		case 8680:  
			strncpy(strValue,"CHANG",HZ2PY_MAX_PINYIN_SIZE);
			break;  
		case 6687:  
		case 7443:  
		case 8173:  
			strncpy(strValue,"CHAO",HZ2PY_MAX_PINYIN_SIZE); 
			break;  
		case 5969:  
		case 7726:  
			strncpy(strValue,"CHE",HZ2PY_MAX_PINYIN_SIZE);  
			break;  
		case 5840:  
		case 5863:  
		case 6251:  
		...
		case 7755:  
		case 8619:  
			strncpy(strValue,"CHEN",HZ2PY_MAX_PINYIN_SIZE);
			break;  
		case 5609:  
		case 5984:  
		case 7239:  
		...
		case 8241:  
		case 8508:  
			strncpy(strValue,"CHENG",HZ2PY_MAX_PINYIN_SIZE);
			break;  
		case 5749:  
		case 6015:  
		case 6061:  
		...
		case 8556:  
		case 8746:  
			strncpy(strValue,"CHI",HZ2PY_MAX_PINYIN_SIZE);
			break;  
		case 6091:  
		case 6671:  
		case 6731:  
		case 8409:  
		case 8430:  
			strncpy(strValue,"CHONG",HZ2PY_MAX_PINYIN_SIZE);
			break;  
		case 5717:  
		case 6492:  
		case 6716:  
		case 8112:  
		case 8637: 
			strncpy(strValue,"CHOU",HZ2PY_MAX_PINYIN_SIZE); 
			break;  
		case 5601:  
		case 5927:  
		case 6680:  
		...
		case 8573:  
		case 8777:  
			strncpy(strValue,"CHU",HZ2PY_MAX_PINYIN_SIZE);
			break;  
		case 6285:  
		case 6408:  
		case 7590:  
		case 8563:  
			strncpy(strValue,"CHUAI",HZ2PY_MAX_PINYIN_SIZE); 
			break;  
		case 6622:  
		case 6955:  
		case 7516:  
		case 7843:  
		case 8413:  
			strncpy(strValue,"CHUAN",HZ2PY_MAX_PINYIN_SIZE);
			break;  
		case 6675:  
			strncpy(strValue,"CHUANG",HZ2PY_MAX_PINYIN_SIZE);
			break;  
		case 5879:  
		case 7302:  
		case 7319: 
			strncpy(strValue,"CHUI",HZ2PY_MAX_PINYIN_SIZE); 
			break;  
		case 6127:  
		case 8040:  
		case 8277:  
			strncpy(strValue,"CHUN",HZ2PY_MAX_PINYIN_SIZE); 
			break;  
		case 7401: 
		case 8554:  
		case 8626:  
			strncpy(strValue,"CHUO",HZ2PY_MAX_PINYIN_SIZE); 
			break;  
		case 6075:  
		case 6358:  
		case 7684:  
		case 8043: 
		case 8457:  
			strncpy(strValue,"CI",HZ2PY_MAX_PINYIN_SIZE); 
			break;  
		case 6042:
		case 6840: 
		case 7085: 
		...
		case 7214: 
		case 7240: 
			strncpy(strValue,"CONG",HZ2PY_MAX_PINYIN_SIZE);
			break; 
		case 7308:
		case 7403: 
		case 7577:
			strncpy(strValue,"COU",HZ2PY_MAX_PINYIN_SIZE);
			break; 
		case 6180:
		case 6562:
		case 6607:
		...
		case 8530:
		case 8577:
			strncpy(strValue, "CU",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5764:
		case 6305:
		case 7664:
		case 7973:
			strncpy(strValue, "CUAN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6718:
		case 6145:
		case 6393:
		...
		case 7505:
		case 8631:
			strncpy(strValue, "CUI",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6666:
		case 8169:
			strncpy(strValue, "CUN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5640:
		case 6547:
		case 7566:
		...
		case 8526:
		case 8567:
			strncpy(strValue, "CUO",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6239:
		case 6353:
		case 6410:
		...
		case 8716:
		case 8718:
			strncpy(strValue, "DA",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6004:
		case 6316:
		case 6523:
		...
		case 7173:
		case 8776:
			strncpy(strValue, "DAI",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5757:
		case 6144:
		case 6402:
		...
		case 8185:
		case 8376:
			strncpy(strValue, "DAN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5852:
		case 5942:
		case 6148:
		...
		case 7885:
		case 8141:
			strncpy(strValue, "DANG",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6322:
		case 6665:
		case 7514:
		case 8478:
			strncpy(strValue, "DAO",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 7929:
			strncpy(strValue, "DE",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6466:
		case 6556:
		case 7413:
		...
		case 7975:
		case 8403:
			strncpy(strValue, "DENG",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5621:
		case 5765:
		case 5814:
		...
		case 8438:
		case 8730:
			strncpy(strValue, "DI",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6439:
			strncpy(strValue, "DIA",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5871:
		case 5967:
		case 6559:
		...
		case 8401:
		case 8558:
			strncpy(strValue, "DIAN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 7886:
		case 8585:
		case 8684:
			strncpy(strValue, "DIAO",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5976:
		case 6006:
		case 6273:
		...
		case 8562:
		case 8688:
			strncpy(strValue, "DIE",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5674:
		case 6404:
		case 7164:
		...
		case 8184:
		case 8490:
			strncpy(strValue, "DING",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 7891:
			strncpy(strValue, "DIU",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5977:
		case 6343:
		case 6520:
		...
		case 7747:
		case 8020:
			strncpy(strValue, "DONG",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6190:
		case 8128:
		case 8229:
		case 8391:
			strncpy(strValue, "DOU",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6022:
		case 6429:
		case 6834:
		...
		case 8739:
		case 8782:
			strncpy(strValue, "DU",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 7318:
		case 7649:
		case 8393:
			strncpy(strValue, "DUAN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 7701:
		case 7713:
		case 7752:
			strncpy(strValue, "DUI",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6771:
		case 7632:
		case 7727:
		...
		case 7970:
		case 8527:
			strncpy(strValue, "DUN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6345:
		case 6365:
		case 6785:
		...
		case 8154:
		case 8566:
			strncpy(strValue, "DUO",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5612:
		case 5832:
		case 5844:
		...
		case 8206:
		case 8689:
			strncpy(strValue, "E",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6176:
		case 6284:
			strncpy(strValue, "EN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5706:
		case 6939:
		case 7177:
		...
		case 8660:
		case 2294:
			strncpy(strValue, "ER",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5950:
		case 7732:
			strncpy(strValue, "FA",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6212:
		case 6232:
		case 6506:
		...
		case 7818:
		case 8576:
			strncpy(strValue, "FAN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5890:
		case 7242:
		case 7853:
		case 8419:
		case 8648:
			strncpy(strValue, "FANG",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6032:
		case 6584:
		case 6713:
		...
		case 8613:
		case 8678:
			strncpy(strValue, "FEI",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5739:
		case 6915:
		case 7291:
		case 8687:
		case 8787:
			strncpy(strValue, "FEN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5726:
		case 5926:
		case 6155:
		...
		case 6767:
		case 7731:
			strncpy(strValue, "FENG",HZ2PY_MAX_PINYIN_SIZE);
			break;
			strncpy(strValue, "FO",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 8330:
			strncpy(strValue, "FOU",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5775:
		case 5776:
		case 5914:
		...
		case 8654:
		case 8691:
			strncpy(strValue, "FU",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6246:
		case 7056:
		case 7057:
		case 7424:
		case 7837:
			strncpy(strValue, "GA",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5604:
		case 5875:
		case 5982:
		case 7414:
		case 7464:
			strncpy(strValue, "GAI",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5965:
		case 6053:
		case 6247:
		...
		case 8065:
		case 8491:
			strncpy(strValue, "GAN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 7716:
		case 7824:
		case 8364:
			strncpy(strValue, "GANG",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5626:
		case 5830:
		case 5912:
		...
		case 7429:
		case 7915:
			strncpy(strValue, "GAO",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5610:
		case 5678:
		case 5933:
		...
		case 8420:
		case 8732:
			strncpy(strValue, "GE",HZ2PY_MAX_PINYIN_SIZE);
			break;
			strncpy(strValue, "GEI",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5608:
		case 6102:
		case 6371:
		case 8462:
			strncpy(strValue, "GEN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6376:
		case 6657:
		case 7114:
		case 8665:
			strncpy(strValue, "GENG",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 7178:
		case 7537:
		case 8228:
		case 8601:
			strncpy(strValue, "GONG",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5694:
		case 5824:
		case 6524:
		...
		case 8384:
		case 8724:
			strncpy(strValue, "GOU",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5637:
		case 5812:
		case 6152:
		...
		case 8681:
		case 8729:
			strncpy(strValue, "GU",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5652:
		case 5820:
		case 6341:
		...
		case 7550:
		case 8027:
			strncpy(strValue, "GUA",HZ2PY_MAX_PINYIN_SIZE);
			break;
			strncpy(strValue, "GUAI",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5736:
		case 6124:
		case 6272:
		...
		case 8170:
		case 8704:
			strncpy(strValue, "GUAN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6359:
		case 6578:
		case 7270:
		case 7555:
			strncpy(strValue, "GUANG",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5648:
		case 5659:
		case 6649:
		...
		case 8657:
		case 8712:
			strncpy(strValue, "GUI",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5782:
		case 7121:
		case 7762:
		case 8671:
			strncpy(strValue, "GUN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5769:
		case 6266:
		case 6335:
		...
		case 8268:
		case 8269:
			strncpy(strValue, "GUO",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 7894:
			strncpy(strValue, "HA",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6443:
		case 7560:
		case 8516:
			strncpy(strValue, "HAI",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5885:
		case 6153:
		case 6294:
		...
		case 8232:
		case 8793:
			strncpy(strValue, "HAN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6776:
		case 7112:
		case 8194:
			strncpy(strValue, "HANG",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6179:
		case 6222:
		case 6438:
		...
		case 8211:
		case 8226:
			strncpy(strValue, "HAO",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5813:
		case 5932:
		case 5954:
		...
		case 8234:
		case 8471:
			strncpy(strValue, "HE",HZ2PY_MAX_PINYIN_SIZE);
			break;
			strncpy(strValue, "HEI",HZ2PY_MAX_PINYIN_SIZE);
			break;
			strncpy(strValue, "HEN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6231:
		case 7181:
		case 7276:
			strncpy(strValue, "HENG",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5768:
		case 5774:
		case 5807:
		...
		case 6740:
		case 6792:
			strncpy(strValue, "HONG",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6009:
		case 6565:
		case 6943:
		...
		case 8655:
		case 8731:
			strncpy(strValue, "HOU",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5792:
		case 6392:
		case 6481:
		...
		case 8513:
		case 8590:
			strncpy(strValue, "HU",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 7072:
		case 7275:
		case 7725:
		case 7892:
			strncpy(strValue, "HUA",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 8555:
			strncpy(strValue, "HUAI",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5928:
		case 6140:
		case 6307:
		...
		case 8673:
		case 8763:
			strncpy(strValue, "HUAN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5882:
		case 6569:
		case 6850:
		...
		case 8382:
		case 8692:
			strncpy(strValue, "HUANG",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5822:
		case 6078:
		case 6086:
		...
		case 8319:
		case 8766:
			strncpy(strValue, "HUI",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5827:
		case 6638:
		case 6752:
		case 6867:
			strncpy(strValue, "HUN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5669:
		case 6229:
		case 6311:
		...
		case 8175:
		case 8322:
			strncpy(strValue, "HUO",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5629:
		case 5632:
		case 5662:
		...
		case 8757:
		case 8768:
			strncpy(strValue, "JI",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5704:
		case 5903:
		case 6171:
		...
		case 8434:
		case 8542:
			strncpy(strValue, "JIA",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5752:
		case 5841:
		case 5857:
		...
		case 8668:
		case 8721:
			strncpy(strValue, "JIAN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6092:
		case 6814:
		case 7113:
		...
		case 8461:
		case 8488:
			strncpy(strValue, "JIANG",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5714:
		case 5753:
		case 6020:
		...
		case 8551:
		case 8662:
			strncpy(strValue, "JIAO",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5806:
		case 5821:
		case 6255:
		...
		case 8658:
		case 8726:
			strncpy(strValue, "JIE",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5865:
		case 6103:
		case 6132:
		...
		case 7478:
		case 8138:
			strncpy(strValue, "JIN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5751:
		case 5869:
		case 6128:
		...
		case 6936:
		case 7671:
			strncpy(strValue, "JIONG",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5754:
		case 6417:
		case 6746:
		...
		case 8481:
		case 8761:
			strncpy(strValue, "JIU",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5738:
		case 5810:
		case 6036:
		...
		case 8634:
		case 8722:
			strncpy(strValue, "JU",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5918:
		case 6590:
		case 6824:
		...
		case 7952:
		case 8633:
			strncpy(strValue, "JUAN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5642:
		case 5667:
		case 5860:
		...
		case 8574:
		case 8591:
			strncpy(strValue, "JUE",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6260:
		case 8168:
		case 8362:
		case 8769:
			strncpy(strValue, "JUN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5671:
		case 6339:
		case 7544:
			strncpy(strValue, "KA",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5660:
		case 5978:
		case 6160:
		...
		case 7920:
		case 7939:
			strncpy(strValue, "KAI",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5709:
		case 6108:
		case 7412:
		case 7772:
		case 7811:
			strncpy(strValue, "KAN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5688:
		case 6742:
		case 7854:
			strncpy(strValue, "KANG",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6974:
		case 7264:
		case 7491:
		case 7877:
			strncpy(strValue, "KAO",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6430:
		case 6519:
		case 6701:
		...
		case 8282:
		case 8733:
			strncpy(strValue, "KE",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 8144:
			strncpy(strValue, "KEN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 7912:
			strncpy(strValue, "KENG",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5737:
		case 6539:
		case 8377:
			strncpy(strValue, "KONG",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6050:
		case 6202:
		case 6321:
		case 7778:
		case 8356:
			strncpy(strValue, "KOU",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5658:
		case 6005:
		case 6423:
		case 7111:
		case 8728:
			strncpy(strValue, "KU",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5708:
			strncpy(strValue, "KUA",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5665:
		case 5906:
		case 6364:
		case 6586:
		case 7558:
			strncpy(strValue, "KUAI",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 8737:
			strncpy(strValue, "KUAN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5818:
		case 5831:
		case 5887:
		...
		case 7094:
		case 7460:
			strncpy(strValue, "KUANG",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5624:
		case 5649:
		case 5771:
		...
		case 8606:
		case 8743:
			strncpy(strValue, "KUI",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6204:
		case 6245:
		case 6458:
		...
		case 7841:
		case 8051:
			strncpy(strValue, "LIAO",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5793:
		case 5988:
		case 6270:
		...
		case 8581:
		case 8764:
			strncpy(strValue, "LIE",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6194:
		case 6388:
		case 6555:
		...
		case 8579:
		case 8775:
			strncpy(strValue, "LIN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5925:
		case 6063:
		case 6342:
		...
		case 8465:
		case 8676:
			strncpy(strValue, "LING",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6815:
		case 6962:
		case 7082:
		...
		case 8050:
		case 8644:
			strncpy(strValue, "LIU",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5966:
		case 6055:
		case 6781:
		...
		case 7735:
		case 8110:
			strncpy(strValue, "LONG",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5745:
		case 6168:
		case 6422:
		...
		case 8287:
		case 8735:
			strncpy(strValue, "LOU",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6744:
		case 7321:
		case 7586:
		...
		case 7989:
		case 8158:
			strncpy(strValue, "LV",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5968:
		case 6303:
		case 6464:
		...
		case 8421:
		case 8652:
			strncpy(strValue, "LU",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5785:
		case 7014:
		case 7279:
		case 8029:
		case 8639:
			strncpy(strValue, "LUAN",HZ2PY_MAX_PINYIN_SIZE);
			break;
			strncpy(strValue, "LUE",HZ2PY_MAX_PINYIN_SIZE);
			break;
			strncpy(strValue, "LUN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5732:
		case 5789:
		case 6093:
		...
		case 8107:
		case 8635:
			strncpy(strValue, "LUO",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6328:
			strncpy(strValue, "M",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6373:
		case 6579:
		case 7054:
		case 7231:
		case 8301:
			strncpy(strValue, "MA",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5929:
		case 6104:
		case 8618:
			strncpy(strValue, "MAI",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6012:
		case 6503:
		case 7147:
		...
		case 8709:
		case 8720:
			strncpy(strValue, "MAN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5888:
		case 6861:
		case 7743:
		case 8294:
			strncpy(strValue, "MANG",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5783:
		case 6066:
		case 6525:
		...
		case 8317:
		case 8754:
			strncpy(strValue, "MAO",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6114:
		case 6550:
		case 6613:
		...
		case 8139:
		case 8740:
			strncpy(strValue, "MEI",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6249:
		case 7643:
		case 7715:
		case 7845:
			strncpy(strValue, "MEN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5934:
		case 6189:
		case 6211:
		...
		case 8427:
		case 8431:
			strncpy(strValue, "MENG",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5634:
		case 5855:
		case 6234:
		...
		case 8767:
		case 8771:
			strncpy(strValue, "MI",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6770:
		case 6837:
		case 6847:
		case 7579:
		case 7777:
			strncpy(strValue, "MIAN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6387:
		case 6967:
		case 7131:
		...
		case 7780:
		case 8037:
			strncpy(strValue, "MIAO",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5631:
		case 6367:
		case 8326:
		case 8390:
			strncpy(strValue, "MIE",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6069:
		case 6526:
		case 6741:
		...
		case 8710:
		case 8628:
			strncpy(strValue, "MIN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5804:
		case 6088:
		case 6873:
		...
		case 7808:
		case 8504:
			strncpy(strValue, "MING",HZ2PY_MAX_PINYIN_SIZE);
			break;
			strncpy(strValue, "MIU",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5851:
		case 6052:
		case 6175:
		...
		case 8588:
		case 8765:
			strncpy(strValue, "MO",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5716:
		case 6372:
		case 7788:
		...
		case 8290:
		case 8642:
			strncpy(strValue, "MOU",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5679:
		case 5973:
		case 6057:
		...
		case 7504:
		case 7866:
			strncpy(strValue, "MU",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6437:
			strncpy(strValue, "N",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6264:
		case 7539:
		case 7953:
		case 8136:
			strncpy(strValue, "NA",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5630:
		case 6021:
		case 6133:
		case 7245:
			strncpy(strValue, "NAI",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6411:
		case 6478:
		case 6479:
		...
		case 8279:
		case 8486:
			strncpy(strValue, "NAN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6313:
		case 6476:
		case 6646:
		case 7457:
			strncpy(strValue, "NANG",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5611:
		case 5981:
		case 6346:
		...
		case 7883:
		case 8245:
			strncpy(strValue, "NAO",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5811:
			strncpy(strValue, "NE",HZ2PY_MAX_PINYIN_SIZE);
			break;
			strncpy(strValue, "NEI",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 7705:
			strncpy(strValue, "NEN",HZ2PY_MAX_PINYIN_SIZE);
			break;
			strncpy(strValue, "NENG",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5703:
		case 5972:
		case 6605:
		...
		case 7874:
		case 8682:
			strncpy(strValue, "NI",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5605:
		case 5994:
		case 7393:
		...
		case 8651:
		case 8683:
			strncpy(strValue, "NIAN",HZ2PY_MAX_PINYIN_SIZE);
			break;
			strncpy(strValue, "NIANG",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6064:
		case 7053:
		case 7569:
		case 8433:
			strncpy(strValue, "NIAO",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5877:
		case 6233:
		case 6431:
		...
		case 8411:
		case 8570:
			strncpy(strValue, "NIE",HZ2PY_MAX_PINYIN_SIZE);
			break;
			strncpy(strValue, "NIN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5690:
		case 6344:
		case 6924:
		case 8187:
			strncpy(strValue, "NING",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6580:
		case 6678:
		case 7004:
			strncpy(strValue, "NIU",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5715:
		case 6370:
			strncpy(strValue, "NONG",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 8181:
			strncpy(strValue, "NOU",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6983:
		case 7032:
		case 7059:
		case 7069:
			strncpy(strValue, "NU",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 7704:
		case 7847:
		case 8412:
			strncpy(strValue, "NV",HZ2PY_MAX_PINYIN_SIZE);
			break;
			strncpy(strValue, "NUAN",HZ2PY_MAX_PINYIN_SIZE);
			break;
			strncpy(strValue, "NUE",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5748:
		case 6289:
		case 6386:
		case 7927:
			strncpy(strValue, "NUO",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6424:
		case 6462:
			strncpy(strValue, "O",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5809:
		case 6670:
		case 7417:
		case 8178:
			strncpy(strValue, "OU",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6166:
		case 7243:
		case 8365:
			strncpy(strValue, "PA",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5729:
		case 6169:
		case 6363:
			strncpy(strValue, "PAI",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6761:
		case 6790:
		case 8140:
		...
		case 8320:
		case 8571:
			strncpy(strValue, "PAN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6561:
		case 6872:
		case 6944:
		case 8306:
			strncpy(strValue, "PANG",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6243:
		case 6583:
		case 6650:
		case 7567:
		case 8069:
			strncpy(strValue, "PAO",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6446:
		case 6490:
		case 7623:
		...
		case 8512:
		case 8612:
			strncpy(strValue, "PEI",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6852:
			strncpy(strValue, "PEN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6001:
		case 6456:
		case 6681:
		case 8318:
			strncpy(strValue, "PENG",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5607:
		case 5682:
		case 5880:
		...
		case 8271:
		case 8589:
			strncpy(strValue, "PI",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5850:
		case 7073:
		case 7490:
		...
		case 8470:
		case 8568:
			strncpy(strValue, "PIAN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5666:
		case 6449:
		case 7046:
		...
		case 7809:
		case 8310:
			strncpy(strValue, "PIAO",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6054:
		case 7513:
			strncpy(strValue, "PIE",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 7041:
		case 6253:
		case 7016:
		...
		case 7482:
		case 8213:
			strncpy(strValue, "PIN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5723:
		case 7019:
		case 7250:
		case 8650:
			strncpy(strValue, "PING",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5647:
		case 5922:
		case 7174:
		...
		case 8011:
		case 8345:
			strncpy(strValue, "PO",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5786:
		case 6269:
			strncpy(strValue, "POU",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5773:
		case 6459:
		case 6863:
		...
		case 7972:
		case 8575:
			strncpy(strValue, "PU",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5633:
		case 5725:
		case 5963:
		...
		case 8702:
		case 8772:
			strncpy(strValue, "QI",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6154:
		case 8736:
			strncpy(strValue, "QIA",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5727:
		case 5761:
		case 5868:
		...
		case 8215:
		case 8373:
			strncpy(strValue, "QIAN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6762:
		case 7045:
		case 7341:
		...
		case 8439:
		case 8536:
			strncpy(strValue, "QIANG",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5668:
		case 5829:
		case 5859:
		...
		case 8546:
		case 8719:
			strncpy(strValue, "QIAO",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5907:
		case 6711:
		case 7010:
		...
		case 7938:
		case 8370:
			strncpy(strValue, "QIE",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6043:
		case 6276:
		case 6336:
		...
		case 8291:
		case 8432:
			strncpy(strValue, "QIN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6060:
		case 6485:
		case 7349:
		...
		case 8675:
		case 8784:
			strncpy(strValue, "QING",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5886:
		case 6068:
		case 8123:
		...
		case 8528:
		case 8638:
			strncpy(strValue, "QIONG",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5720:
		case 5947:
		case 6576:
		...
		case 8690:
		case 8792:
			strncpy(strValue, "QIU",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5816:
		case 5930:
		case 6201:
		...
		case 8636:
		case 8781:
			strncpy(strValue, "QU",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5825:
		case 6085:
		case 6710:
		...
		case 8360:
		case 8760:
			strncpy(strValue, "QUAN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6755:
		case 6758:
		case 7708:
			strncpy(strValue, "QUE",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6950:
			strncpy(strValue, "QUN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6059:
		case 8237:
		case 8755:
			strncpy(strValue, "RAN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 7692:
		case 8006:
			strncpy(strValue, "RANG",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6073:
		case 7012:
		case 7267:
			strncpy(strValue, "RAO",HZ2PY_MAX_PINYIN_SIZE);
			break;
			strncpy(strValue, "RE",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5680:
		case 6083:
		case 6156:
		...
		case 7994:
		case 8137:
			strncpy(strValue, "REN",HZ2PY_MAX_PINYIN_SIZE);
			break;
			strncpy(strValue, "RENG",HZ2PY_MAX_PINYIN_SIZE);
			break;
			strncpy(strValue, "RI",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6541:
		case 6585:
		case 7337:
		case 7532:
		case 8278:
			strncpy(strValue, "RONG",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 8459:
		case 8569:
		case 8723:
			strncpy(strValue, "ROU",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6174:
		case 6224:
		case 6473:
		...
		case 8164:
		case 8212:
			strncpy(strValue, "RU",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 7535:
			strncpy(strValue, "RUAN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6039:
		case 6208:
		case 7236:
		case 7803:
		case 8224:
			strncpy(strValue, "RUI",HZ2PY_MAX_PINYIN_SIZE);
			break;
			strncpy(strValue, "RUN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5728:
		case 8372:
			strncpy(strValue, "RUO",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5606:
		case 5677:
		case 7493:
		case 7559:
		case 7610:
			strncpy(strValue, "SA",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6471:
			strncpy(strValue, "SAI",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6644:
		case 7507:
		case 8454:
			strncpy(strValue, "SAN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6290:
		case 7763:
		case 8210:
			strncpy(strValue, "SANG",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6003:
		case 7150:
		case 7156:
		...
		case 8094:
		case 8694:
			strncpy(strValue, "SAO",HZ2PY_MAX_PINYIN_SIZE);
			break;
			strncpy(strValue, "SE",HZ2PY_MAX_PINYIN_SIZE);
			break;
			strncpy(strValue, "SEN",HZ2PY_MAX_PINYIN_SIZE);
			break;
			strncpy(strValue, "SENG",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6394:
		case 7606:
		case 7901:
		...
		case 8614:
		case 8672:
			strncpy(strValue, "SHA",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 8507:
			strncpy(strValue, "SHAI",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5663:
		case 5808:
		case 5923:
		...
		case 8539:
		case 8713:
			strncpy(strValue, "SHAN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5980:
		case 7120:
		case 7368:
		case 7656:
		case 8592:
			strncpy(strValue, "SHUANG",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5931:
		case 6070:
		case 6891:
		...
		case 8366:
		case 8425:
			strncpy(strValue, "SHAO",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5639:
		case 5760:
		case 6606:
		...
		case 7820:
		case 8774:
			strncpy(strValue, "SHE",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5837:
		case 6123:
		case 6351:
		...
		case 7982:
		case 8255:
			strncpy(strValue, "SHEN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6551:
		case 7441:
		case 7782:
		case 8347:
			strncpy(strValue, "SHENG",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5854:
		case 5985:
		case 6110:
		...
		case 8669:
		case 8685:
			strncpy(strValue, "SHI",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6587:
		case 7123:
		case 8428:
			strncpy(strValue, "SHOU",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5731:
		case 5951:
		case 6136:
		...
		case 7582:
		case 7988:
			strncpy(strValue, "SHU",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6407:
			strncpy(strValue, "SHUA",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 8316:
			strncpy(strValue, "SHUAI",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6737:
		case 6844:
			strncpy(strValue, "SHUAN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 7055:
			strncpy(strValue, "SHUANG",HZ2PY_MAX_PINYIN_SIZE);
			break;
			strncpy(strValue, "SHUI",HZ2PY_MAX_PINYIN_SIZE);
			break;
			strncpy(strValue, "SHUN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6184:
		case 6287:
		case 6989:
		case 7335:
		case 7869:
			strncpy(strValue, "SHUO",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5643:
		case 5778:
		case 5944:
		...
		case 8247:
		case 8351:
			strncpy(strValue, "SI",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5801:
		case 6131:
		case 6534:
		...
		case 6833:
		case 8121:
			strncpy(strValue, "SONG",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5937:
		case 6220:
		case 6418:
		...
		case 7943:
		case 8284:
			strncpy(strValue, "SOU",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5777:
		case 5853:
		case 6188:
		...
		case 8602:
		case 8653:
			strncpy(strValue, "SU",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6601:
			strncpy(strValue, "SUAN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5839:
		case 6120:
		case 6901:
		...
		case 7785:
		case 7801:
			strncpy(strValue, "SUI",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6105:
		case 6588:
		case 6624:
		case 7330:
		case 8632:
			strncpy(strValue, "SUN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6379:
		case 6434:
		case 6442:
		...
		case 7792:
		case 8440:
			strncpy(strValue, "SUO",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6743:
		case 6866:
		case 6961:
		...
		case 8533:
		case 8703:
			strncpy(strValue, "TA",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5902:
		case 6223:
		case 6330:
		...
		case 8544:
		case 8656:
			strncpy(strValue, "TAI",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5916:
		case 6903:
		case 7428:
		...
		case 7936:
		case 8191:
			strncpy(strValue, "TAN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5746:
		case 6491:
		case 6871:
		...
		case 8442:
		case 8517:
			strncpy(strValue, "TANG",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5627:
		case 6391:
		case 6812:
		case 7226:
		case 7666:
			strncpy(strValue, "TAO",HZ2PY_MAX_PINYIN_SIZE);
			break;
			strncpy(strValue, "1845 餐",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6315:
		case 7693:
		case 7911:
			strncpy(strValue, "TE",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 7588:
			strncpy(strValue, "TENG",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5735:
		case 6709:
		case 6949:
		...
		case 8151:
		case 8514:
			strncpy(strValue, "TI",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6261:
		case 6735:
		case 6757:
		case 7369:
		case 7817:
			strncpy(strValue, "TIAN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5712:
		case 7686:
		case 8127:
		...
		case 8670:
		case 8756:
			strncpy(strValue, "TIAO",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6138:
		case 8749:
			strncpy(strValue, "TIE",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6080:
		case 6167:
		case 7035:
		...
		case 8249:
		case 8610:
			strncpy(strValue, "TING",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5701:
		case 5758:
		case 6077:
		...
		case 6892:
		case 7737:
			strncpy(strValue, "TONG",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 7855:
		case 7822:
		case 8727:
			strncpy(strValue, "TOU",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6002:
		case 6117:
		case 6143:
		case 7842:
		case 8509:
			strncpy(strValue, "TU",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6250:
		case 6972:
			strncpy(strValue, "TUAN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 7653:
			strncpy(strValue, "TUI",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5759:
		case 6629:
		case 7453:
		case 7564:
			strncpy(strValue, "TUN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5617:
		case 5702:
		case 5971:
		...
		case 8541:
		case 8630:
			strncpy(strValue, "TUO",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5684:
		case 7020:
		case 7580:
			strncpy(strValue, "WA",HZ2PY_MAX_PINYIN_SIZE);
			break;
			strncpy(strValue, "WAI",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5664:
		case 6025:
		case 6150:
		...
		case 7821:
		case 8274:
			strncpy(strValue, "WAN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5672:
		case 6244:
		case 6715:
		case 7394:
		case 8745:
			strncpy(strValue, "WANG",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5743:
		case 5835:
		case 5881:
		...
		case 8426:
		case 8659:
			strncpy(strValue, "WEI",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5656:
		case 6751:
		case 6775:
		case 7223:
		case 8609:
			strncpy(strValue, "WEN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6178:
		case 6219:
			strncpy(strValue, "WENG",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5733:
		case 6111:
		case 6502:
		...
		case 7750:
		case 8627:
			strncpy(strValue, "WO",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5603:
		case 5685:
		case 5867:
		...
		case 8640:
		case 8789:
			strncpy(strValue, "WU",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5750:
		case 5766:
		case 5884:
		...
		case 8521:
		case 8791:
			strncpy(strValue, "XI",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6340:
		case 6582:
		case 6958:
		...
		case 8333:
		case 8779:
			strncpy(strValue, "XIA",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5794:
		case 5823:
		case 6040:
		...
		case 8549:
		case 8617:
			strncpy(strValue, "XIAN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6028:
		case 6157:
		case 6635:
		...
		case 8663:
		case 8747:
			strncpy(strValue, "XIANG",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6356:
		case 6537:
		case 6876:
		...
		case 8379:
		case 8744:
			strncpy(strValue, "XIAO",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5741:
		case 5784:
		case 5936:
		...
		case 7339:
		case 8583:
			strncpy(strValue, "XIE",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5622:
		case 6016:
		case 7431:
		case 7607:
		case 8646:
			strncpy(strValue, "XIN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5874:
		case 6084:
		case 6309:
		case 6712:
		case 7742:
			strncpy(strValue, "XING",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6026:
			strncpy(strValue, "XIONG",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6361:
		case 6522:
		case 6642:
		...
		case 8587:
		case 8759:
			strncpy(strValue, "XIU",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5828:
		case 5935:
		case 5955:
		...
		case 8458:
		case 8515:
			strncpy(strValue, "XU",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5756:
		case 5846:
		case 6170:
		...
		case 7964:
		case 8071:
			strncpy(strValue, "XUAN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5842:
		case 7720:
		case 8529:
		case 8708:
			strncpy(strValue, "XUE",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5767:
		case 5908:
		case 5987:
		...
		case 8524:
		case 8664:
			strncpy(strValue, "XUN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5683:
		case 5975:
		case 6275:
		...
		case 7793:
		case 8073:
			strncpy(strValue, "YA",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5641:
		case 5645:
		case 5718:
		...
		case 8748:
		case 8790:
			strncpy(strValue, "YAN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6564:
		case 6683:
		case 7630:
		...
		case 8253:
		case 8717:
			strncpy(strValue, "YANG",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5618:
		case 5619:
		case 6326:
		...
		case 8477:
		case 8705:
			strncpy(strValue, "YAO",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5644:
		case 5843:
		case 5894:
		...
		case 7639:
		case 7884:
			strncpy(strValue, "YE",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5655:
		case 5657:
		case 5670:
		...
		case 8493:
		case 8780:
			strncpy(strValue, "YI",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5623:
		case 5920:
		case 5983:
		...
		case 8615:
		case 8624:
			strncpy(strValue, "YIN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5788:
		case 5911:
		case 6067:
		...
		case 8203:
		case 8331:
			strncpy(strValue, "YING",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6401:
			strncpy(strValue, "YO",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5724:
		case 5953:
		case 6013:
		...
		case 8711:
		case 8751:
			strncpy(strValue, "YONG",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5653:
		case 5692:
		case 5707:
		...
		case 8778:
		case 8788:
			strncpy(strValue, "YOU",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5614:
		case 5625:
		case 5681:
		...
		case 8607:
		case 8625:
			strncpy(strValue, "YU",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5989:
		case 6011:
		case 6282:
		...
		case 8378:
		case 8629:
			strncpy(strValue, "YUAN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5763:
		case 6914:
		case 7348:
		case 7530:
		case 7865:
			strncpy(strValue, "YUE",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5909:
		case 6031:
		case 6581:
		...
		case 7521:
		case 7657:
			strncpy(strValue, "YUN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6257:
		case 6338:
			strncpy(strValue, "ZA",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6544:
		case 7162:
			strncpy(strValue, "ZAI",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 7222:
		case 7435:
		case 8402:
		...
		case 8485:
		case 8641:
			strncpy(strValue, "ZAN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6242:
		case 7064:
		case 7416:
			strncpy(strValue, "ZANG",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6380:
			strncpy(strValue, "ZAO",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5638:
		case 8369:
		case 5651:
		...
		case 8348:
		case 8423:
			strncpy(strValue, "ZE",HZ2PY_MAX_PINYIN_SIZE);
			break;
			strncpy(strValue, "ZEI",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5858:
			strncpy(strValue, "ZEN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 7153:
		case 7421:
		case 7832:
		case 7913:
			strncpy(strValue, "ZENG",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6610:
		case 6274:
		case 6324:
		...
		case 8238:
		case 8794:
			strncpy(strValue, "ZHA",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 7746:
		case 8109:
			strncpy(strValue, "ZHAI",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5862:
		case 6288:
		case 7625:
			strncpy(strValue, "ZHAN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5675:
		case 5921:
		case 6504:
		...
		case 7216:
		case 8315:
			strncpy(strValue, "ZHANG",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5815:
		case 7294:
		case 7840:
		case 8341:
			strncpy(strValue, "ZHAO",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5856:
		case 6301:
		case 7247:
		...
		case 8256:
		case 8487:
			strncpy(strValue, "ZHE",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5958:
		case 6172:
		case 6805:
		...
		case 8018:
		case 8380:
			strncpy(strValue, "ZHEN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5826:
		case 6531:
		case 6571:
		...
		case 7903:
		case 8361:
			strncpy(strValue, "ZHENG",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5620:
		case 5876:
		case 5904:
		...
		case 8584:
		case 8603:
			strncpy(strValue, "ZHI",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5803:
		case 7981:
		case 8314:
		case 8417:
		case 8564:
			strncpy(strValue, "ZHONG",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6107:
		case 6390:
		case 7008:
		...
		case 8406:
		case 8492:
			strncpy(strValue, "ZHOU",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5689:
		case 5710:
		case 5905:
		...
		case 8578:
		case 8770:
			strncpy(strValue, "ZHU",HZ2PY_MAX_PINYIN_SIZE);
			break;
			strncpy(strValue, "ZHUA",HZ2PY_MAX_PINYIN_SIZE);
			break;
			strncpy(strValue, "ZHUAI",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6389:
		case 6645:
		case 8207:
			strncpy(strValue, "ZHUAN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5755:
			strncpy(strValue, "ZHUANG",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6723:
		case 7077:
		case 7136:
			strncpy(strValue, "ZHUI",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 7538:
		case 8124:
			strncpy(strValue, "ZHUN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5730:
		case 5834:
		case 6310:
		...
		case 7729:
		case 7977:
			strncpy(strValue, "ZHUO",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5849:
		case 6549:
		case 7002:
		...
		case 8686:
		case 8758:
			strncpy(strValue, "ZI",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5744:
		case 7574:
		case 8453:
			strncpy(strValue, "ZONG",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5833:
		case 5878:
		case 5924:
		case 7067:
		case 8677:
			strncpy(strValue, "ZOU",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5762:
		case 6147:
		case 7963:
			strncpy(strValue, "ZU",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6312:
		case 7158:
		case 8582:
			strncpy(strValue, "ZUAN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6209:
			strncpy(strValue, "ZUI",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 6304:
		case 7355:
		case 8714:
			strncpy(strValue, "ZUN",HZ2PY_MAX_PINYIN_SIZE);
			break;
		case 5872:
		case 6382:
		case 6460:
		...
		case 7549:
		case 7681:
			strncpy(strValue, "ZUO",HZ2PY_MAX_PINYIN_SIZE);
			break;
		default:
			...
			if (nCode >= 3003 && nCode <= 3027) {
				strncpy(strValue, "JING",HZ2PY_MAX_PINYIN_SIZE);
				break;
			}
			...
			if (nCode >= 3204 && nCode <= 3207) {
				strncpy(strValue, "KUN",HZ2PY_MAX_PINYIN_SIZE);
				break;
			}
			if (nCode >= 3208 && nCode <= 3211) {
				strncpy(strValue, "KUO",HZ2PY_MAX_PINYIN_SIZE);
				break;
			}
			if (nCode >= 3212 && nCode <= 3218) {
				strncpy(strValue, "LA",HZ2PY_MAX_PINYIN_SIZE);
				break;
			}
			if (nCode >= 3219 && nCode <= 3221) {
				strncpy(strValue, "LAI",HZ2PY_MAX_PINYIN_SIZE);
				break;
			}
			if (nCode >= 3222 && nCode <= 3236) {
				strncpy(strValue, "LAN",HZ2PY_MAX_PINYIN_SIZE);
				break;
			}
			if (nCode >= 3237 && nCode <= 3243) {
				strncpy(strValue, "LANG",HZ2PY_MAX_PINYIN_SIZE);
				break;
			}
			if (nCode >= 3244 && nCode <= 3252) {
				strncpy(strValue, "LAO",HZ2PY_MAX_PINYIN_SIZE);
				break;
			}
			if (nCode >= 3253 && nCode <= 3254) {
				strncpy(strValue, "LE",HZ2PY_MAX_PINYIN_SIZE);
				break;
			}
			if (nCode >= 3255 && nCode <= 3265) {
				strncpy(strValue, "LEI",HZ2PY_MAX_PINYIN_SIZE);
				break;
			}
			if (nCode >= 3266 && nCode <= 3268) {
				strncpy(strValue, "LENG",HZ2PY_MAX_PINYIN_SIZE);
				break;
			}
			if (nCode >= 3269 && nCode <= 3308) {
				strncpy(strValue, "LI",HZ2PY_MAX_PINYIN_SIZE);
				break;
			}
			if (nCode == 3309) {
				strncpy(strValue, "LIA",HZ2PY_MAX_PINYIN_SIZE);
				break;
			}
			if (nCode >= 3310 && nCode <= 3323) {
				strncpy(strValue, "LIAN",HZ2PY_MAX_PINYIN_SIZE);
				break;
			}
			if (nCode >= 3324 && nCode <= 3334) {
				strncpy(strValue, "LIANG",HZ2PY_MAX_PINYIN_SIZE);
				break;
			}
			...
			if (nCode == 3520) {
				strncpy(strValue, "ME",HZ2PY_MAX_PINYIN_SIZE);
				break;
			}
			...
			if (nCode >= 4142 && nCode <= 4149) {
				strncpy(strValue, "SHANG",HZ2PY_MAX_PINYIN_SIZE);
				break;
			}
			...
			strncpy(strValue, "?",HZ2PY_MAX_PINYIN_SIZE);
			return 0;
	}
	return 1;
}
void textConvert::pinyin_gb2312(char * inbuf, char * outbuf, bool m_blnSimaple , bool polyphone_support , bool m_blnFirstBig , bool m_blnAllBiG , bool m_LetterEnd , bool m_unknowSkip , bool m_filterPunc) {
	/*
...
char* textConvert::getPinYin(char* inbuf) 
{
	...
	if (is_utf8_string(inbuf)) {
		printf("utf8:",HZ2PY_MAX_PINYIN_SIZE);
		pinyin_utf8(inbuf, outbuf);
	} else {
		printf("gb2312:",HZ2PY_MAX_PINYIN_SIZE);
